            ...
            <div class="popup-content">
                ...
                <div class="friends-list" style="height: 180px;width:100%; overflow-y: scroll; overflow-x: hidden;">
                    ...
                    if (!empty($mutualFollows)): ?>
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <p id="no-result" style="color:red;">No mutual follows found. You need to follow each other to
                            create a group.</p>
                    <?php endif; ?>
                </div>
                <button type="button" class="create-button" onclick="createGroup()">CREATE</button>
            </div>
        </div>
    </div>
