        ...
        <div class="container">
            ...
            <main class="message-list">
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<div class="message unread" onclick="location.href=\'chat(cn).php?receiverID=' . $receiverID . '\';" style="cursor: pointer;">
               ...
               GROUP_CONCAT(u.userName ORDER BY u.userName ASC SEPARATOR ', ') AS members
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<div class="message unread" onclick="location.href=\'groupChat(cn).php?groupID=' . $groupID . '\';" style="cursor: pointer;">
        ...
        <div class="popup-banner" id="popupBanner">
            <div class="popup-content">
                ...
                <div class="input-group">
                    <label for="groupImage">群组头像</label>
                ...
                <div class="friends-list" style="height: 180px;width:100%; overflow-y: scroll; overflow-x: hidden;">
                    ...
                    if (!empty($mutualFollows)): ?>
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <p id="no-result" style="color:red;">请添加好友.</p>
                    <?php endif; ?>
                </div>
                <button type="button" class="create-button" onclick="createGroup()">创建</button>
            </div>
        </div>
    </div>
