...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["mark_all_read"])) {
    ...
    header("Location: notification(cn).php");
    exit;
}
...
<body>
    ...
    <div class="container">
        <div class="notificationContainer">
            <header>
                <div class="header">
                    <div class="back">
                        <button type="button" onclick="window.location.href='main(cn).php'">
                ...
                <form method="POST" action="notification(cn).php" id="mark-all-form">
                    <input type="hidden" name="mark_all_read" value="1">
                    <p id="mark-as-read">全部标记为已读</p>
                </form>
            </header>
            <main class="notifications">
                <?php foreach ($notifications as $notif):
                    ...
                    <div class="notification-entry">
                        <form method="POST" action="notification(cn).php" class="notif-form">
    ...
    <script>
        function followUser(event, username) {
            ...
            window.location.href = "friend(cn).php";
        }
