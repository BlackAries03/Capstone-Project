...
if (!isset($groupID) || !is_numeric($groupID)) {
    ...
    setTimeout(function() {
        window.location.href = "message(bm).php"; 
    }, 250); 
    </script>';
    exit();
}
...
<body>
    ...
    <div class="main-content">
        <header class="header">
            <button class="return-button" onclick="window.location.href='message(bm).php'">
        ...
        <div class="container">
            ...
            <footer class="chat-footer">
                <form id="chatGroupForm">
                    ...
                    <textarea id="messageGroupInput" name="message" placeholder="taip mesej di sini..." rows="4"></textarea>
            ...
            <div class="popup-content">
                ...
                <?php if ($userRole == 'creator'): ?>
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="addMember" placeholder=" Masukkan nama ahli" />
                    </div>
                    <div class="friends-list" style="height: 100px; width:100%; overflow-y: scroll; overflow-x: hidden;">
                        ...
                        if (!empty($mutualFollows)):
                            ...
                            ?>
                            <p id="no-result" style="color:red;">Tiada pengguna lain yang dijumpai.</p>
                        <?php endif; ?>
                    </div>

                    <div class="input-group">
                        <label for="MemberList">Senarai Ahli</label>
                        <input type="text" id="MemberList" placeholder=" Masukkan nama ahli" />
                    </div>
                    <div class="friends-list" style="height: 100px; width:100%; overflow-y: scroll; overflow-x: hidden;">
                        <?php
                        $groupMembers = [];
                        ...
                        if (!empty($groupMembers)):
                            ...
                            ?>
                            <p id="no-result" style="color:red;">Tiada ahli yang dijumpai dalam kumpulan.</p>
                        <?php endif; ?>
                    </div>
                <?php else: ?>
                    <div class="input-group">
                    ...
                    <script>
                        ...
                        document.getElementById("leaveGroup").addEventListener("click", function () {
                            if (confirm("Adakah anda pasti ingin meninggalkan kumpulan ini?")) {
                                ...
                                fetch("leaveGroup.php", {
                                    ...
                                    .then(data => {
                                        if (data.success) {
                                            alert("Anda telah meninggalkan kumpulan.");
                                            window.location.href = "message(bm).php";
                                        } else {
