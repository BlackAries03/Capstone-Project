...
<head>
  ...
  <style>
    ...
    #option h1 {
      ...
      /* Untuk meluruskan tajuk secara sebaris */
      margin-left: 10px;
      /* Laraskan margin untuk jarak */
    }
...
<body>
  ...
  <?php include("sidebar(bm).php"); ?>
    ...
    <div class="content">
      <div id="title">
        <a href="main(bm).php"><img src="picture\back-button.png" alt="kembali" class="back"
      ...
      <div class="container">
        <div class="options">
          <a href="_accountManagement(bm).php">
            <div id="option">
              <div id="title" style="padding-left: 30px;">
                <img src="picture\images-removebg-preview.png" alt="akaun" style="height: auto; width: 80px;">
          ...
          <a href="_privacyNPolicy(bm).php">
            <div id="option">
              <div id="title" style="padding-left: 30px;">
                <img src="picture\pngtree-protection-line-icon-vector-png-image_6690997-removebg-preview.png" alt="P&P">
                <h1>PRIVASI DAN DASAR</h1>
              </div>
            </div>
          </a>
          <a href="_aboutUs(bm).php">
            <div id="option">
              <div id="title" style="padding-left: 30px;">
                <img src="picture\download-removebg-preview (1).png" alt="tentangKami">
                <h1>TENTANG KAMI</h1>
              </div>
            </div>
          </a>
          <a href="_Help(bm).php">
            <div id="option">
              <div id="title" style="padding-left: 30px;">
                <img src="picture\images-removebg-preview (1).png" alt="bantuan">
                <h1>BANTUAN</h1>
              </div>
            </div>
          </a>
          <div id="option">
            ...
            <div id="dropDownMenu2">
                <ul>
                  <li id="theme-default" onclick="setTheme('default')">Terang</li>
                  <li id="theme-dark" onclick="setTheme('dark')">Gelap</li>
                </ul>
            </div>
          </div>
        </div>
