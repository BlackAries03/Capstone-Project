        ...
        <div class="container">
            <header>
                ...
                <div class="search-container">
                    ...
                    <input type="text" id="recomend-search" placeholder="Search...">
                </div>
            </header>
            <div id="no-result" style="display:none;">Unable to find person</div>
            <div class="friends-list">
                <?php include 'randomSuggestion.php'; ?>
            </div>
        </div>
        <br>
        <br>
                            ...
                            <div class="friend unread" onclick="this.parentNode.submit();">
                                ...
                                <div class="description">
                                    ...
                                    <div class="follow-container">
                                        <div class="follow-box">Unfollow</div>
                                    </div>
                                </div>
                            </div>
                        </form>
