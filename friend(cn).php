        ...
        <div class="container">
            <header>
                ...
                <div class="search-container">
                    ...
                    <input type="text" id="recomend-search" placeholder="搜索...">
                </div>
            </header>
            <div id="no-result" style="display:none;">无法找到该人</div>
            <div class="friends-list">
                <?php include 'randomSuggestion(cn).php'; ?>
            </div>
        </div>
        <br>
        <br>
            ...
            <div class="friends-list">
                <?php if (!empty($followedUsers)): ?>
                    <?php foreach ($followedUsers as $user): ?>
                        <form method="POST" action="follow_action(cn).php">
