            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th>aID</th>
                        <th>Tajuk</th>
                        <th>Jenis kemas kini</th>
                        <th>Penerangan</th>
                    </tr>
                </thead>
                <tbody id="editTableBody"></tbody>
            </table>
            <button class="update-button" onclick="updateAnnouncements()">Kemas kini</button>
            <button class="delete-button" onclick="deleteAnnouncements()">Padam</button>
        </div>
    ...
    <div id="announcementModalOverlay" class="announcement-modal-overlay">
        <div class="announcement-modal">
            ...
            <div class="announcement-modal-content">
                <p><strong>Jenis Kemaskini: </strong><span id="modalUpdateType"></span></p>
                <p><strong>Masa: </strong><span id="modalTimestamp"></span></p>
