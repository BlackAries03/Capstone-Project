...
<body>
  <div class="layout">
    ...
    <div class="content">
      <div id="title">
        <a href="main(cn).php"><img src="picture\back-button.png" alt="返回" class="back"
      ...
      <div class="container">
        <div class="options">
          <a href="_accountManagement(cn).php">
            <div id="option">
              <div id="title" style="padding-left: 30px;">
                <img src="picture\images-removebg-preview.png" alt="账户管理" style="height: auto; width: 80px;">
                <h1>账户管理</h1>
              </div>
            </div>
          </a>
          ...
          <a href="_privacyNPolicy(cn).php">
            <div id="option">
              <div id="title" style="padding-left: 30px;">
                <img src="picture\pngtree-protection-line-icon-vector-png-image_6690997-removebg-preview.png" alt="隐私和政策">
                <h1>隐私和政策</h1>
              </div>
            </div>
          </a>
          <a href="_aboutUs(cn).php">
            <div id="option">
              <div id="title" style="padding-left: 30px;">
                <img src="picture\download-removebg-preview (1).png" alt="关于我们">
                <h1>关于我们</h1>
              </div>
            </div>
          </a>
          <a href="_Help(cn).php">
            <div id="option">
              <div id="title" style="padding-left: 30px;">
                <img src="picture\images-removebg-preview (1).png" alt="帮助">
                <h1>帮助</h1>
              </div>
            </div>
          </a>
          <div id="option">
            ...
            <div id="dropDownMenu2">
                <ul>
                    <li id="theme-default" onclick="setTheme('default')">光明</li>
                    <li id="theme-dark" onclick="setTheme('dark')">黑暗</li>
                </ul>
            </div>
          </div>
        </div>
