  ...
  <div class="main-home">
    <div class="header">
      ...
      <div class="header-content">
        <img src="picture/notification.png" alt="notification icon" onclick="window.location.href='notification.php'">

        <a href="#" class="btn">
          <img src="picture/add.png" alt="add icon">
          <div class="btn-text">Add posts</div>
    ...
    <div class="feed-container">
      ...
      <div id="no-result" style="display: none; text-align: center; margin-top: 20px;">
        No posts found. Please search again!
      </div>
    </div>
    <div id="overlay" class="overlay">
      <div id="maximizedFeed" class="maximized-feed">
        <button class="return-button" onClick="closeOverlay()">Return</button>
        ...
        <div class="interaction-section">
          ...
          <div class="comment-input-container">
            <textarea id="commentInput" placeholder="Add a comment..." onkeydown="handleCommentInput(event)"></textarea>
          </div>
        </div>
      </div>
    </div>
    <div id="popup-banner" class="popup">
      <div class="popup-content">
        ...
        <form id="upload-form" action="mainDB.php" method="POST" enctype="multipart/form-data"
          ...
          <input type="text" name="Fname" id="photo-title" placeholder="Enter title" class="large-input" required />
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function () {
        function uploadPhoto(event) {
          ...
          if (file && allowedTypes.includes(file.type)) {
            ...
            alert("Please upload a valid image file (JPEG, PNG, GIF, WEBP, or BMP).");
          }
        }
      ...
      function validateTitle(event) {
        ...
        if (badWordsPattern.test(title)) {
          event.preventDefault();
          titleError.textContent = 'Title contains inappropriate content. Please modify your title.';
