  ...
  <div class="main-home">
    <div class="header">
      <div class="search">
        ...
        <input type="text" id="searchBar" placeholder="Cari" oninput="filterPosts()" />
      </div>
      <div class="header-content">
        <img src="picture/notification.png" alt="notification icon" onclick="window.location.href='notification(bm).php'">

        <a href="#" class="btn">
          <img src="picture/add.png" alt="add icon">
          <div class="btn-text">Tambah Pos</div>
    ...
    <div class="feed-container">
      <div class="grid" id="gridContainer">
        ...
        if ($result->num_rows > 0) {
          ...
          echo '<p>Tiada siaran ditemui</p>';
        }
        $conn->close();
        ?>
      </div>
      <div id="no-result" style="display: none; text-align: center; margin-top: 20px;">
        Tiada siaran ditemui. Sila cari lagi!
      </div>
    </div>
    <div id="overlay" class="overlay">
      <div id="maximizedFeed" class="maximized-feed">
        <button class="return-button" onClick="closeOverlay()">Pulang</button>
        ...
        <div class="interaction-section">
          ...
          <div class="comment-input-container">
            <textarea id="commentInput" placeholder="Tambahkan koment..." onkeydown="handleCommentInput(event)"></textarea>
          </div>
        </div>
      </div>
    </div>
    <div id="popup-banner" class="popup">
      <div class="popup-content">
        ...
        <form id="upload-form" action="mainDB.php" method="POST" enctype="multipart/form-data"
          ...
          <label for="photo-title">Tajuk:</label>
          <input type="text" name="Fname" id="photo-title" placeholder="Masukkan tajuk" class="large-input" required />
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function () {
        function uploadPhoto(event) {
          ...
          if (file && allowedTypes.includes(file.type)) {
            ...
            alert("Sila muat naik fail imej yang sah (JPEG, PNG, GIF, WEBP atau BMP).");
          }
        }
      ...
      async function fetchLikeCount(feedId) {
        try {
          ...
          if (result.success) {
            ...
            likeCountElement.textContent = result.likes + "    Suka";
          }
        } catch (error) {
      ...
      async function loadComments(feedId) {
        try {
          ...
          if (data.length === 0) {
            commentsList.innerHTML = '<p>Tiada komen lagi. Jadilah yang pertama untuk komen!</p>';
            return;
          }
          ...
          const commentsList = document.getElementById('commentsList');
          commentsList.innerHTML = '<p>Ralat memuatkan komen. Sila cuba lagi.</p>';
        }
      }
      ...
      async function addComment() {
        ...
        try {
          ...
          console.error('Kesalahan menambah koment:', error);
        }
      }
      ...
      function formatRelativeTime(dateString) {
        ...
        if (diff < minute) {
          ...
          return `${minutes} minit${minutes > 1 ? '' : ''} yang lalu`;
        } else if (diff < day) {
          ...
          return `${years} tahun${years > 1 ? '' : ''} yang lalu`;
        }
      }
      ...
      function validateTitle(event) {
        ...
        if (badWordsPattern.test(title)) {
          event.preventDefault();
          titleError.textContent = 'Tajuk mengandungi kandungan yang tidak sesuai. Sila ubah suai tajuk anda.';
