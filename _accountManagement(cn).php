...
<body>
        ...
        <div class="profile">
            <form action="uploads.php" method="post" enctype="multipart/form-data" id="uploadForm">
                <div class="profile-img">
                    <label for="fileInput">
                        <img src="picture/add.png" alt="添加个人资料" class="main-img" id="addProfileImage">
                        <img src="<?php echo !empty($profilePic) ? $profilePic : 'picture/unknown.jpeg'; ?>"
                            alt="头像" class="overlay-img" />
                    </label>
            ...
            <div class="name">
                ...
                <img src="picture/verified.png" alt="已认证" />
            </div>
    ...
    <div class="options">
        <a href="#" id="UNameEdit">
            <div id="option">
                <div id="title" style="padding-left: 30px;">
                    <img src="picture\images-removebg-preview (4).png" alt="用户名" style="height: auto;width: 80px;">
                    <h1>更改用户名</h1>
                </div>
            </div>
        </a>
        ...
        <a href="#" id="EmailEdit">
            <div id="option">
                <div id="title" style="padding-left: 30px;">
                    <img src="picture\download-removebg-preview (4).png" alt="邮件" style="height: auto;width: 80px;">
                    <h1>更新邮箱账户</h1>
                </div>
            </div>
        </a>
        <a href="#" id="PhoneEdit">
            <div id="option">
                <div id="title" style="padding-left: 30px;">
                    <img src="picture\download-removebg-preview (5).png" alt="电话" style="height: auto;width: 80px;">
                    <h1>更新电话号码</h1>
                </div>
            </div>
        </a>
        <a href="#" id="PswEdit">
            <div id="option">
                <div id="title" style="padding-left: 30px;">
                    <img src="picture\download-removebg-preview (6).png" alt="密码" style="height: auto;width: 80px;">
                    <h1>重置密码</h1>
                </div>
            </div>
        </a>
        <a href="#" id="DelAcc">
            <div id="option" style="background-color: red;">
                <div id="title" style="padding-left: 30px;">
                    <img src="picture\download-removebg-preview (7).png" alt="删除账户" style="height: auto;width: 80px;">
                    <h1>删除账户</h1>
                </div>
            </div>
        </a>
    ...
    <div id="changeUName" class="box">
        <div class="item">
            ...
            <form id="username-form" method="post">
                ...
                <input type="text" placeholder="新用户名" id="new-username" name="new-username" required>
    ...
    <div id="changePhone" class="box">
        <div class="item">
            ...
            <form id="phone-form" method="post">
                <label for="new-phone">新电话号码</label>
                <input type="tel" placeholder="+601234567890" pattern="(\+60)[0-9]{9,10}" name="new-phone" id="new-phone" required>
                <button type="submit">提交</button>
            </form>
        </div>
    </div>
    ...
    <div id="changePsw" class="box" style="display: none;">
        <div class="item">
            ...
            <form id="psw-form" method="post">
                <label for="psw-email">邮箱地址</label>
                <input type="email" placeholder="XXX@gmail.com" pattern="[a-zA-Z0-9._%+-]+@(gmail\.com|hotmail\.com|yahoo\.com|apu\.edu\.my)" name="psw-email" id="psw-email" required>
                <button type="button" id="request-otp">请求 OTP</button>
                <label for="otp-code">输入 OTP</label>
    ...
    <div id="changePsw2" class="box" style="display: none;">
        <div class="item">
            ...
            <form id="psw2-form" method="post">
                <label for="new-psw">新密码</label>
                <input type="password" placeholder="密码" name="psw" id="psw" required>
                <button type="submit">提交</button>
            </form>
        </div>
    </div>
    ...
    <script>
        ...
        document.getElementById('psw-form').addEventListener('submit', function (event) {
            ...
            .then(response => response.json())
            .then(data => {
                console.log("用户输入的 OTP:", userOTP);
                console.log("服务器响应:", data);

                if (data.status === "success") {
                    document.getElementById('changePsw').style.display = 'none';
                    document.getElementById('changePsw2').style.display = 'block';
                } else if (data.message === "会话已过期，请请求新的 OTP。") {
                    alert("会话已过期，请请求新的 OTP。");
                } else {
                    alert('无效的 OTP，请重试。');
                }
            })
    ...
    <div id="delAcc" class="box">
        <div class="item">
            ...
            <form id="delAcc-form" method="post">
                <img src="picture\download-removebg-preview (8).png" alt="警告">
                <br>
                <span style="color: red; font-size: 11px">您确定要删除此帐户吗？</span>
                <br>
                <span style="color: red; font-size: 10px;">此操作无法撤销！</span>
                <br>
                <button type="submit" style="background-color: green;">取消</button>
                <br>
                <button type="submit" style="background-color: red;">确认</button>
            </form>
        </div>
    </div>
    <script>
